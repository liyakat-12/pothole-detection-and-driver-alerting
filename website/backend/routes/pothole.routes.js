...
import { uploadPotholeData, getPotholeStatus, analyzePotholeImage, liveDetect, getNearbyPotholes, getAllPotholes } from "../controllers/pothole.controller.js";

const router = express.Router()

router.get('/', getAllPotholes);
router.get('/status/:id', getPotholeStatus);
